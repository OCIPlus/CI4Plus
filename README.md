...
> composer create-project codeigniterplus/version4

This will add the latest stable release of codeigniterplus/version4 as a module to your project. Note that you may need to adjust your project's minimum stability in order to use codeigniterplus/version4 while it is in beta.
