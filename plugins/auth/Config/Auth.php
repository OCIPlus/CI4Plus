...
class Auth extends BaseConfig
{
    ...
    public $authenticationLibs = [
        'local' => 'Auth\Authentication\LocalAuthenticator',
    ];
     ...
     */
    public $requireActivation = 'Auth\Authentication\Activators\EmailActivator';
     ...
     */
    public $activeResetter = 'Auth\Authentication\Resetters\EmailResetter';
    ...
    public $passwordValidators = [
        'Auth\Authentication\Passwords\CompositionValidator',
        'Auth\Authentication\Passwords\NothingPersonalValidator',
        'Auth\Authentication\Passwords\DictionaryValidator',
        // 'Auth\Authentication\Passwords\PwnedValidator',
    ];
    ...
    public $userActivators = [
        'Auth\Authentication\Activators\EmailActivator' => [
            'fromEmail' => null,
            'fromName'  => null,
        ],
    ];
    ...
    public $userResetters = [
        'Auth\Authentication\Resetters\EmailResetter' => [
            'fromEmail' => null,
            'fromName'  => null,
        ],
    ];
