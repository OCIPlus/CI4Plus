...
namespace Auth\Authentication\Passwords;
...
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * comes from Auth\Entities\User properties username and email.
     *
     ...
     * the `$personalFields` property in Auth\Config\Auth, e.g.
     *
     ...
     * Similarity values equal to, or greater than Auth\Config::maxSimilarity
