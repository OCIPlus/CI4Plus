...
class Publish extends BaseCommand
{
    ...
    /**
     * The path to Auth\src directory.
     *
     * @var string
     */
    ...
    protected function publishModels()
    {
        ...
        foreach ($models as $model) {
            ...
            $content = $this->replaceNamespace($content, 'Auth\Models', 'Models');
    ...
    protected function publishEntities()
    {
        ...
        $content = file_get_contents($path);
        $content = $this->replaceNamespace($content, 'Auth\Entities', 'Entities');
    ...
    protected function publishController()
    {
        ...
        $content = file_get_contents($path);
        $content = $this->replaceNamespace($content, 'Auth\Controllers', 'Controllers');
    ...
    protected function publishView($view, string $prefix = '')
    {
        ...
        $content = file_get_contents($path);
        $content = str_replace('Auth\Views', $namespace . '\Views\Auth', $content);
    ...
    protected function publishFilters()
    {
        ...
        foreach ($filters as $filter) {
            ...
            $content = file_get_contents($path);
            $content = $this->replaceNamespace($content, 'Auth\Filters', 'Filters');
    ...
    protected function publishMigration()
    {
        ...
        foreach ($map as $file) {
            ...
            $content = $this->replaceNamespace($content, 'Auth\Database\Migrations', 'Database\Migrations');
    ...
    protected function publishConfig()
    {
        ...
        $content = file_get_contents($path);
        $content = str_replace('namespace Auth\Config', 'namespace Config', $content);
    ...
    /**
     * Replaces the Auth namespace in the published
