...
/**
 * Create a Plugin in Modular structure
 *
...
class PluginCreate extends BaseCommand
{
     ...
     * @var string
     */
    protected $description = 'Create CodeIgniter plugins in plugins folder';
     ...
     * @var string
     */
    protected $usage        = 'plugin:create [PluginName] [Options]';
     ...
     * @var array
     */
    protected $arguments    = [ 'PluginName' => 'Plugin name to be created' ];
     ...
     */
    protected $options      = [
        '-f' => 'Set plugin folder other than app/Plugins',
        '-c' => 'Create only con[F]ig, [C]ontroller, [L]ibrary, [M]odel, [V]iew, [O]ther dirs'
    ];

    /**
     * Plugin Name to be Created
     */
    protected $module_name;


    /**
     * Plugin folder (default /plugins)
     */
    ...
    public function run(array $params)
    {
        ...
        CLI::write('Creating plugin '.$this->module_folderOrig . DIRECTORY_SEPARATOR . $this->module_name);
