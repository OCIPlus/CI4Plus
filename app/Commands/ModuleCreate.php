...
class ModuleCreate extends BaseCommand
{
     ...
     * @var string
     */
    protected $description = 'Create CodeIgniter modules in modules folder';
    ...
    public function run(array $params)
    {
        ...
        $this->module_folderOrig   = $module_folder ? ucfirst($module_folder) : 'modules';
...
<?php
    ...
    class ".ucfirst($this->module_name)." extends BaseController {
        /**
         * Constructor.
         *
         */
